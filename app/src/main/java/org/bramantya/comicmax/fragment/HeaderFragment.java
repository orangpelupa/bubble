...
public class HeaderFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(org.bramantya.comicmax.R.layout.fragment_header, container, false);
    ...
    private class HalftonerTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Void... params) {
            ...
            double s = Math.PI/6;
            int a, r, g, b, l, t, f, p;
            int primary = getResources().getColor(org.bramantya.comicmax.R.color.primary);
