...
import org.bramantya.comicmax.Constants;
import org.bramantya.comicmax.activity.ReaderActivity;
import org.bramantya.comicmax.managers.LocalComicHandler;
...
import org.bramantya.comicmax.parsers.RarParser;
import org.bramantya.comicmax.view.ComicViewPager;
import org.bramantya.comicmax.view.PageImageView;
...
public class ReaderFragment extends Fragment implements View.OnTouchListener {
    ...
    static {
        ...
        RESOURCE_VIEW_MODE.put(org.bramantya.comicmax.R.id.view_mode_aspect_fill, Constants.PageViewMode.ASPECT_FILL);
        RESOURCE_VIEW_MODE.put(org.bramantya.comicmax.R.id.view_mode_aspect_fit, Constants.PageViewMode.ASPECT_FIT);
        RESOURCE_VIEW_MODE.put(org.bramantya.comicmax.R.id.view_mode_fit_width, Constants.PageViewMode.FIT_WIDTH);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(org.bramantya.comicmax.R.layout.fragment_reader, container, false);

        mPageNavLayout = (LinearLayout) getActivity().findViewById(org.bramantya.comicmax.R.id.pageNavLayout);
        mPageSeekBar = (SeekBar) mPageNavLayout.findViewById(org.bramantya.comicmax.R.id.pageSeekBar);
        ...
        mPageNavTextView = (TextView) mPageNavLayout.findViewById(org.bramantya.comicmax.R.id.pageNavTextView);
        mViewPager = (ComicViewPager) view.findViewById(org.bramantya.comicmax.R.id.viewPager);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(org.bramantya.comicmax.R.menu.reader, menu);

        switch (mPageViewMode) {
            case ASPECT_FILL:
                menu.findItem(org.bramantya.comicmax.R.id.view_mode_aspect_fill).setChecked(true);
                break;
            case ASPECT_FIT:
                menu.findItem(org.bramantya.comicmax.R.id.view_mode_aspect_fit).setChecked(true);
                break;
            case FIT_WIDTH:
                menu.findItem(org.bramantya.comicmax.R.id.view_mode_fit_width).setChecked(true);
                break;
        }

        if (mIsLeftToRight) {
            menu.findItem(org.bramantya.comicmax.R.id.reading_left_to_right).setChecked(true);
        }
        else {
            menu.findItem(org.bramantya.comicmax.R.id.reading_right_to_left).setChecked(true);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()) {
            case org.bramantya.comicmax.R.id.view_mode_aspect_fill:
            case org.bramantya.comicmax.R.id.view_mode_aspect_fit:
            case org.bramantya.comicmax.R.id.view_mode_fit_width:
                ...
                break;
            case org.bramantya.comicmax.R.id.reading_left_to_right:
            case org.bramantya.comicmax.R.id.reading_right_to_left:
                item.setChecked(true);
                int page = getCurrentPage();
                mIsLeftToRight = (item.getItemId() == org.bramantya.comicmax.R.id.reading_left_to_right);
    ...
    private class ComicPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View layout = inflater.inflate(org.bramantya.comicmax.R.layout.fragment_reader_page, container, false);

            PageImageView pageImageView = (PageImageView) layout.findViewById(org.bramantya.comicmax.R.id.pageImageView);
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            ...
            ImageView iv = (ImageView) layout.findViewById(org.bramantya.comicmax.R.id.pageImageView);
    ...
    private class MyTarget implements Target, View.OnClickListener {
        ...
        private void setVisibility(int imageView, int progressBar, int reloadButton) {
            ...
            layout.findViewById(org.bramantya.comicmax.R.id.pageImageView).setVisibility(imageView);
            layout.findViewById(org.bramantya.comicmax.R.id.pageProgressBar).setVisibility(progressBar);
            layout.findViewById(org.bramantya.comicmax.R.id.reloadButton).setVisibility(reloadButton);
        }
        ...
        public void onBitmapFailed(Drawable errorDrawable) {
            ...
            ImageButton ib = (ImageButton) layout.findViewById(org.bramantya.comicmax.R.id.reloadButton);
    ...
    private void hitBeginning() {
        if (mComic != null) {
            ...
            confirmSwitch(c, org.bramantya.comicmax.R.string.switch_prev_comic);
        }
    }
    ...
    private void hitEnding() {
        if (mComic != null) {
            ...
            confirmSwitch(c, org.bramantya.comicmax.R.string.switch_next_comic);
        }
    }
    ...
    private void confirmSwitch(Comic newComic, int titleRes) {
        ...
        AlertDialog dialog = new AlertDialog.Builder(getActivity(), org.bramantya.comicmax.R.style.AppCompatAlertDialogStyle)
                .setTitle(titleRes)
                .setMessage(newComic.getFile().getName())
                .setPositiveButton(org.bramantya.comicmax.R.string.switch_action_positive, new DialogInterface.OnClickListener() {
                    @Override
                ...
                .setNegativeButton(org.bramantya.comicmax.R.string.switch_action_negative, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        mNewComic = null;
                    }
    ...
    private void updateSeekBar() {
        int seekRes = (mIsLeftToRight)
                ? org.bramantya.comicmax.R.drawable.reader_nav_progress
                : org.bramantya.comicmax.R.drawable.reader_nav_progress_inverse;
