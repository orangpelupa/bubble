package org.bramantya.comicmax.view;
...
public class DirectorySelectDialog
    ...
    public DirectorySelectDialog(Context context) {
        super(context);
        setContentView(org.bramantya.comicmax.R.layout.dialog_directorypicker);
        mSetButton = (Button) findViewById(org.bramantya.comicmax.R.id.directory_picker_confirm);
        mCancelButton = (Button) findViewById(org.bramantya.comicmax.R.id.directory_picker_cancel);
        mListView = (ListView) findViewById(org.bramantya.comicmax.R.id.directory_listview);
        mTitleTextView = (TextView) findViewById(org.bramantya.comicmax.R.id.directory_current_text);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext())
                        .inflate(org.bramantya.comicmax.R.layout.row_directory, parent, false);
            }

            File dir = mSubdirs[position];
            TextView textView = (TextView) convertView.findViewById(org.bramantya.comicmax.R.id.directory_row_text);
